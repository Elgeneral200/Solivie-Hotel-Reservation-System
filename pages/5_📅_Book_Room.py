...
with col1:
    ...
    # MOVED OUTSIDE FORM - Handle form submission results
    if cancel:
                ...
                if success:
                    ...
                    if booking:
                        ...
                        if pay_success:
                            ...
                            # Store success flag for showing buttons
    ...
    # ✅ Show navigation buttons after successful booking (OUTSIDE form)
    if st.session_state.get('booking_success'):
        st.markdown("---")
        col_a, col_b = st.columns(2)
        with col_a:
            if st.button("📋 My Bookings", use_container_width=True, type="primary", key="nav_bookings"):
...
# Add logout button OUTSIDE form at bottom
st.markdown("---")
